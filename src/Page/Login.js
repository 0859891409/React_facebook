  ...
  <div className="form-container">
    <form className="form" onSubmit={handleSubmit(onSubmit)}>
      <div className="input-container">
        <input type="text" placeholder="Email or Phone Number" className="form-input form-input--email"  {...register("email", { required: true})}/>
      ...
      <div className="input-container input-container--password">
        <input type="password" placeholder="Password" className="form-input form-input--password" {...register("password", { required: true})}/>
